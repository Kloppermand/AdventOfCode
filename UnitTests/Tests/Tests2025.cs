...
namespace UnitTests.Tests2025
{
    public class Tests
    {
        const string root = "../../../../AdventOfCode2025/";
        [SetUp]
        public void Setup()
        {
        }
        ...
        public void Day1A()
        {
            ...
            Assert.That(result, Is.EqualTo("1141"));
        }
        ...
        public void Day1B()
        {
            ...
            Assert.That(result, Is.EqualTo("6634"));
        }
        ...
        public void Day2A()
        {
            ...
            Assert.That(result, Is.EqualTo("31210613313"));
        }
        ...
        public void Day4A()
        {
            ...
            Assert.That(result, Is.EqualTo("1549"));
        }
        ...
        public void Day4B()
        {
            ...
            Assert.That(result, Is.EqualTo("8887"));
        }
        ...
        public void Day5A()
        {
            ...
            Assert.That(result, Is.EqualTo("529"));
        }
        ...
        public void Day5B()
        {
            ...
            Assert.That(result, Is.EqualTo("344260049617193"));
        }
        ...
        public void Day6A()
        {
            ...
            Assert.That(result, Is.EqualTo("6757749566978"));
        }
        ...
        public void Day6B()
        {
            ...
            Assert.That(result, Is.EqualTo("10603075273949"));
        }
        ...
        public void Day7A()
        {
            ...
            Assert.That(result, Is.EqualTo("1579"));
        }
        ...
        public void Day7B()
        {
            ...
            Assert.That(result, Is.EqualTo("13418215871354"));
        }
        ...
        public void Day8A()
        {
            ...
            Assert.That(result, Is.EqualTo("122430"));
        }
