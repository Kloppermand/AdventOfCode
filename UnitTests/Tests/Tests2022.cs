using aoc = AdventOfCode2022;
using Utilities;
using System.Reflection.Metadata;

namespace UnitTests.Tests2022
{
    public class Tests
    {
        const string root = "../../../../AdventOfCode2022/";
        [SetUp]
        public void Setup()
        {
        }
        ...
        public void Day1A()
        {
            ...
            Assert.That(result, Is.EqualTo("69883"));
        }
        ...
        public void Day1B()
        {
            ...
            Assert.That(result, Is.EqualTo("207576"));
        }
        ...
        public void Day2A()
        {
            ...
            Assert.That(result, Is.EqualTo("11603"));
        }
        ...
        public void Day2B()
        {
            ...
            Assert.That(result, Is.EqualTo("12725"));
        }
        ...
        public void Day4B()
        {
            ...
            Assert.That(result, Is.EqualTo("815"));
        }
        ...
        public void Day5A()
        {
            ...
            Assert.That(result, Is.EqualTo("FRDSQRRCD"));
        }
        ...
        public void Day5B()
        {
            ...
            Assert.That(result, Is.EqualTo("HRFTQVWNN"));
        }
        ...
        public void Day6A()
        {
            ...
            Assert.That(result, Is.EqualTo("1538"));
        }
        ...
        public void Day6B()
        {
            ...
            Assert.That(result, Is.EqualTo("2315"));
        }
        ...
        public void Day7A()
        {
            ...
            Assert.That(result, Is.EqualTo("1845346"));
        }
        ...
        public void Day7B()
        {
            ...
            Assert.That(result, Is.EqualTo("3636703"));
        }
        ...
        public void Day8A()
        {
            ...
            Assert.That(result, Is.EqualTo("1776"));
        }
        ...
        public void Day8B()
        {
            ...
            Assert.That(result, Is.EqualTo("234416"));
        }
        ...
        public void Day9A()
        {
            ...
            Assert.That(result, Is.EqualTo("6486"));
        }
        ...
        public void Day9B()
        {
            ...
            Assert.That(result, Is.EqualTo("2678"));
        }
        ...
        public void Day10A()
        {
            ...
            Assert.That(result, Is.EqualTo("16480"));
        }
        ...
        public void Day10B()
        {
            ...
            Assert.That(result, Is.EqualTo("PLEFULPB"));
        }
        ...
        public void Day11A()
        {
            ...
            Assert.That(result, Is.EqualTo("55458"));
        }
        ...
        public void Day11B()
        {
            ...
            Assert.That(result, Is.EqualTo("14508081294"));
        }
        ...
        public void Day12A()
        {
            ...
            Assert.That(result, Is.EqualTo("520"));
        }
        ...
        public void Day12B()
        {
            ...
            Assert.That(result, Is.EqualTo("508"));
        }
        ...
        public void Day13A()
        {
            ...
            Assert.That(result, Is.EqualTo("5623"));
        }
        ...
        public void Day13B()
        {
            ...
            Assert.That(result, Is.EqualTo("20570"));
        }
        ...
        public void Day14B()
        {
            ...
            Assert.That(result, Is.EqualTo("26831"));
        }
        ...
        public void Day15A()
        {
            ...
            Assert.That(result, Is.EqualTo("4502208"));
        }
        ...
        public void Day15B()
        {
            ...
            Assert.That(result, Is.EqualTo("13784551204480"));
        }
    }
}