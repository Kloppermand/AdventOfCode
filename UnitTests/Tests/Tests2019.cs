using aoc = AdventOfCode2019;
using Utilities;
using System.Reflection.Metadata;

namespace UnitTests.Tests2019
{
    public class Tests
    {
        const string root = "../../../../AdventOfCode2019/";
        [SetUp]
        public void Setup()
        {
        }
        ...
        public void Day1A()
        {
            ...
            Assert.That(result, Is.EqualTo("3404722"));
        }
        ...
        public void Day1B()
        {
            ...
            Assert.That(result, Is.EqualTo("5104215"));
        }
        ...
        public void Day2A()
        {
            ...
            Assert.That(result, Is.EqualTo("2890696"));
        }
        ...
        public void Day2B()
        {
            ...
            Assert.That(result, Is.EqualTo("8226"));
        }
        ...
        public void Day3A()
        {
            ...
            Assert.That(result, Is.EqualTo("2427"));
        }
        ...
        public void Day3B()
        {
            ...
            Assert.That(result, Is.EqualTo("27890"));
        }
        ...
        public void Day4A()
        {
            ...
            Assert.That(result, Is.EqualTo("1748"));
        }
        ...
        public void Day4B()
        {
            ...
            Assert.That(result, Is.EqualTo("1180"));
        }
